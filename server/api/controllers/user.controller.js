...
const resetPassword = async (req, res, next) => {
  try {
    ...
    const mensaje = {
      from: "Coexist",
      to: email,
      subject: `Contraseña usuario ${previousUser.mail}`,
      html: `
        <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
          ...
          <a href="https://club-navy-seven.vercel.app//new-password/${token}" style="background-color: blue; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Restablecer contraseña</a>
